...
Left: 12 repetitions per bar, whiskers are a 95% confidence interval on the median. Right: nine sizes, 2 repetitions each, so read the shape not the decimals.
