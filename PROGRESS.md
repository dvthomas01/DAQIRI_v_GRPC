...
| P3 | Integrate into the Rust `grpc-direct` transport | **SCOPED, NOT STARTED** | Scoping in `rdma_transport_plan.md` §6. **Blocked**: the Spark is off the network |
